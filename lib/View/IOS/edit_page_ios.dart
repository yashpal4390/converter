...
class edit_page_ios extends StatefulWidget {
  final int? ind;
  edit_page_ios({super.key,this.ind});

  @override
  State<edit_page_ios> createState() => _edit_page_iosState();
}

class _edit_page_iosState extends State<edit_page_ios> {
